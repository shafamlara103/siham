<div class="p-6 sm:px-20 bg-white border-b border-gray-200">
    ...
    <div class="mt-8 text-2xl">
        Welcome to your Largonet Site! Hi {{ Auth::user()->approved_at }}
        @if(Auth::user()->approved_at == Null)
            {{ __('You are not approved yet') }}
            @endif
    </div>

    <div class="mt-6 text-gray-500">
        Largonet Ltd. has been founded in year 2005 as small family company.
        The company is purely manufacturing oriented and up to year 2016 has been working exclusively with foreign clients.
    </div>
</div>
